import os
import requests
# for interacting with OS and fetching from URLs
import streamlit as st  # for creating interactive web apps
import weaviate  # DB client for handling vectorized data
...
hugs = Huggingface()
# proides NLP functionalities
tru = Tru()
# monitors the performance of the AI
